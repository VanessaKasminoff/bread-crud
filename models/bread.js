module.exports = [
  {
    ...
    ingredients: ['bread flour', 'rye flour', 'salt', 'yeast', 'caraway seeds', 'water', 'maple syrup', 'olive oil']
  },
  {
    name: "French",
    hasGluten: true,
    ...
    ingredients: ['flour', 'sugar', 'salt', 'yeast', 'water', 'butter']
  },
  {
    name: "Gluten-Free",
    hasGluten: false,
    ...
    ingredients: ['buckwheat flour', 'potato starch', 'brown rice flour', 'psyllium husk', 'yeast', 'sugar', 'water', 'salt', 'apple cider vinegar']
  },
  {
    name: "Pumpernickel",
    hasGluten: true,
    ...
    ingredients: ['bread flour', 'whole wheat flour', 'cocoa', 'yeast', 'sugar', 'salt', 'water', 'molasses', 'vegetable oil']
  },
];
